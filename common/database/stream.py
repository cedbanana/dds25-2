...
class RedisStreamConsumer:
    def __init__(
        self, redis_client, stream_key: str, consumer_group: str, consumer_name: str, pre_xread: Callable = None
    ):
        self.redis_client = redis_client
        self.stream_key = stream_key
...
class StreamProcessor:
    ...
    def start_worker(self, consumer_group: str, consumer_name: str):
        ...
        consumer = RedisStreamConsumer(
            self.redis_client, self.stream_key, consumer_group, consumer_name, self.pre_xread
        )
